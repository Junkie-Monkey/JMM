onEvent('server.datapack.high_priority', function (event) {
    ...
    event.addJson('jmm:advancements/husbandry/tame_all_animals.json', {
        ...
        display: {
            ...
            title: {
                translate: 'advancements.jmm.husbandry.tame_all_animals.title'
            },
            description: {
                translate: 'advancements.jmm.husbandry.tame_all_animals.description'
            },
            frame: 'challenge',
            show_toast: true,
