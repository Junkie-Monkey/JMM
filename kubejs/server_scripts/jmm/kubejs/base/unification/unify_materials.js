...
onEvent('recipes', (event) => {
    const id_prefix = 'jmm:base/unification/unify_materials/';
    ...
    function emendatus_shapeless_transform(event, material, ore, chunk) {
        ...
        event
            ...
            .id(`jmm:base/emendatusenigmatica/${material}_ore`);
        event
    ...
    function immersiveengineering_hammer_crushing(event, material, ore, dust, gem) {
        ...
        event.shapeless(output, [input, hammer]).id(`jmm:base/jmm/${material}_dust`);
    }
    ...
    function thermal_metal_melting(event, material, block, ingot, nugget, gear, rod, plate) {
        ...
        recipes.forEach((recipe) => {
            event.recipes.thermal
                ...
                .energy(recipe.energy)
                .id(`jmm:base/thermal/crucible/${material}_${recipe.type}`);
        });
    }
