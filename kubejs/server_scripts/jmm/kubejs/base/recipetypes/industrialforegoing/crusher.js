onEvent('recipes', (event) => {
    const recipes = [
        ...
        },
        {
            ...
            id: 'jmm:industrialforegoing/crusher/white_sandstone_sand'
        },
        {
            input: { item: 'byg:blue_sandstone' },
            output: { item: 'byg:blue_sand' },
            id: 'jmm:industrialforegoing/crusher/blue_sandstone_sand'
        },
        {
            input: { item: 'byg:purple_sandstone' },
            output: { item: 'byg:purple_sand' },
            id: 'jmm:industrialforegoing/crusher/purple_sandstone_sand'
        },
        {
            input: { item: 'byg:black_sandstone' },
            output: { item: 'byg:black_sand' },
            id: 'jmm:industrialforegoing/crusher/black_sandstone_sand'
        },
        {
            input: { item: 'minecraft:end_stone' },
            output: { item: 'byg:end_sand' },
            id: 'jmm:industrialforegoing/crusher/end_stone_sand'
        },
        {
            input: { item: 'minecraft:red_sandstone' },
            output: { item: 'minecraft:red_sand' },
            id: 'jmm:industrialforegoing/crusher/red_sandstone_sand'
        },
        {
            input: { item: 'minecraft:sandstone' },
            output: { item: 'minecraft:sand' },
            id: 'jmm:industrialforegoing/crusher/sandstone_sand'
        },
        {
            input: { item: 'atmospheric:arid_sandstone' },
            output: { item: 'atmospheric:arid_sand' },
            id: 'jmm:industrialforegoing/crusher/arid_sandstone_sand'
        }
    ];
