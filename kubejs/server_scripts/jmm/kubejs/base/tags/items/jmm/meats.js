onEvent('item.tags', (event) => {
    ...
    event.get('jmm:meats').add(small_meats).add(medium_meats).add(large_meats);

    event.get('jmm:meats/small').add(small_meats);
    event.get('jmm:meats/medium').add(medium_meats);
    event.get('jmm:meats/large').add(large_meats);
});
